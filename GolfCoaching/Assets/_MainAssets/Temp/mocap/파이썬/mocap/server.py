...
#PIPE_NAME = r"\\.\pipe\MediaPipePoseEstimation"
PIPE_NAME = r"\\.\pipe\skeleton_pipe1"
...
class PoseServer:
    ...
    def start(self):
        ...
        self.thread.start()
        print(f"서버가 정상적으로 실행되었습니다.{PIPE_NAME}")
...
def send_pose(pose_data):
    pose_server.send_pose_data(pose_data)
