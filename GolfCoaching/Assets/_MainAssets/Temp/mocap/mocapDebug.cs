...
public class mocapDebug : MonoBehaviour
{
    ...
    [SerializeField] bool isFront = false;
    ...
    private void Start()
    {
        ...
        if (isFront == false)
        {
            ...
            //PIPE_NAME = PlayerPrefs.GetString("PIPE_NAME_S", "skeleton_pipe2");
    ...
    void UpdateBodyTransform()
    {
        lock (poseData)
        {
            ...
            txtHandVIsible.text = string.Format(format, rk, lk);
        }
